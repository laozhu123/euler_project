...
# def is_origin_in_triangle1(x1, y1, x2, y2, x3, y3):
#     if (x2 - x1) * (x1 * x2 * y3 - y2 * x3 + x3 * y1) == 0:
#         return True
#     t = (x1 * x2 * x2 * x3 * y1 - x1 * x1 * x2 * x3 * y2) / ((x2 - x1) * (x1 * x2 * y3 - y2 * x3 + x3 * y1))
#     if (x2 - t) * (x1 - t) <= 0:
#         return True
#     else:
#         return False
#
#
# def is_origin_in_triangle2(x2, y2, x3, y3, x1, y1):
#     if (x2 - x1) * (x1 * x2 * y3 - y2 * x3 + x3 * y1) == 0:
#         return True
#     t = (x1 * x2 * x2 * x3 * y1 - x1 * x1 * x2 * x3 * y2) / ((x2 - x1) * (x1 * x2 * y3 - y2 * x3 + x3 * y1))
#     if (x2 - t) * (x1 - t) <= 0:
...
#
#
# def is_origin_in_triangle3(x3, y3, x1, y1, x2, y2):
#     if (x2 - x1) * (x1 * x2 * y3 - y2 * x3 + x3 * y1) == 0:
#         return True
#     t = (x1 * x2 * x2 * x3 * y1 - x1 * x1 * x2 * x3 * y2) / ((x2 - x1) * (x1 * x2 * y3 - y2 * x3 + x3 * y1))
#     if (x2 - t) * (x1 - t) <= 0:
...
#         if is_origin_in_triangle1(coords[0], coords[1], coords[2], coords[3], coords[4], coords[5]) \
#                 and is_origin_in_triangle2(coords[0], coords[1], coords[2], coords[3], coords[4], coords[5]) \
#                 and is_origin_in_triangle3(coords[0], coords[1], coords[2], coords[3], coords[4], coords[5]):
#             sum += 1
#     print(sum)
#
#
